	...
	<script type="text/javascript">
		var tzRole = {
			user:function(obj){
				...
				$.tzIframe({width:440,height:250,title:"用户分配角色",content:adminPath+"/role/user/"+opid,callback:function(iframe,$dialog,opts){
					if(iframe){
			...
			permission:function(obj){
				var $obj = $(obj);
				var opid = $obj.data("opid");
				$.tzIframe({width:440,height:350,title:"权限分配",content:adminPath+"/role/permission/"+opid,callback:function(iframe,$dialog,opts){
					if(iframe){
