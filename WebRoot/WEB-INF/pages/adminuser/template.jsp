	...
	<tr>
		...
		<td>
			<tz:if test="${adminuser.forbiden==0}">
				<tz:then><a href="javascript:void(0)" opid="${adminuser.id}" mark="status" val="1" onclick="tzAdmin.op(this);" class="red">否</a></tz:then>
				<tz:else><a href="javascript:void(0)" opid="${adminuser.id}" mark="status" val="0" onclick="tzAdmin.op(this);" class="green">是</a></tz:else>
			</tz:if>	
		</td>	
