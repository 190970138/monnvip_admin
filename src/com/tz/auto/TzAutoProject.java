...
public class TzAutoProject {
	...
	//注释
	private static String description = "数据抓取";
	private static String author = "liu";
	private static String qq = "761008250";
	private static String telephone = "15074816437";
	private static String email = "761008250@qq.com";
